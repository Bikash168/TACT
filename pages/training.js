    ...
    <Layout>
      ...
      <div className="bg-gray-50 text-gray-800">
        ...
        <section className="container mx-auto py-12 px-6 md:px-12">
          <h2 className="text-3xl font-semibold text-indigo-800 text-center">Our Training Programs</h2>
        ...
        <section className="container mx-auto py-12 px-6 md:px-12">
          <h2 className="text-3xl font-semibold text-indigo-800 text-center">Featured Training Categories</h2>
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-2xl font-semibold text-indigo-800">Technical Training</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-2xl font-semibold text-indigo-800">Management Training</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-2xl font-semibold text-indigo-800">Soft Skills Development</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-2xl font-semibold text-indigo-800">Industry Certifications</h3>
              <p className="mt-4 text-lg">Gain valuable certifications from industry leaders to enhance your professional credentials.</p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-2xl font-semibold text-indigo-800">Entrepreneurship Training</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-2xl font-semibold text-indigo-800">Environmental Sustainability</h3>
        ...
        <section className="bg-indigo-100 py-12 px-6 md:px-12">
          <h2 className="text-3xl font-semibold text-indigo-800 text-center">Upcoming Training Events</h2>
          <p className="mt-4 text-center text-lg">
            Don't miss our upcoming training events designed to provide hands-on learning and networking opportunities.
          </p>
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-2xl font-semibold text-indigo-800">Advanced Data Science Workshop</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-2xl font-semibold text-indigo-800">Leadership in Action Training</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-2xl font-semibold text-indigo-800">Entrepreneurship Essentials</h3>
        ...
        {/* Testimonials */}
        <section className="container mx-auto py-12 px-6 md:px-12">
          <h2 className="text-3xl font-semibold text-indigo-800 text-center">What Our Trainees Say</h2>
          <div className="mt-6 flex flex-col items-center">
            <div className="bg-indigo-100 p-6 rounded-lg shadow-md max-w-3xl">
              ...
              <p className="mt-4 font-semibold text-indigo-800">- Priya, Alumni</p>
            </div>
            <div className="bg-indigo-100 p-6 rounded-lg shadow-md max-w-3xl mt-8">
              ...
              <p className="mt-4 font-semibold text-indigo-800">- Arjun, Data Science Enthusiast</p>
            </div>
          </div>
        </section>
      </div>
